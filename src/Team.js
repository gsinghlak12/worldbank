				...
				<div class='card px-5'>
					<div class='card-body text-center'>
						<h5>
							...
							<a href='https://sigmalabs.co.uk/' target='_blank' rel='noreferrer' className='link-dark'>
								Sigma Labs
							</a>{' '}
							in London.
						</h5>
						<p className='px-4'>
							Using the skills learnt during our full-stack training, we have created this data visualisation
							...
							. Since the database contains over 1,300 indicators, we thought it would be beneficial to focus
							on human geography, <br />
							in particular metrics relating to the lives of women around the world. Where the data for men
							relating to the same indicator exists, we have automatically displayed it on the same graph for
							comparison. We hope you find exploring this website as interesting as we found building it!
						</p>
					</div>
				</div>
			</Container>
				...
				<Row>
						...
						<div className='card text-center my-3' style={{ width: '18rem' }}>
							...
							<div className='card-body'>
								...
								<p className='card-text'>
									Adnan is a recent MEng graduate from Imperial College London. He loves how coding brings
					...
					<Col>
						<div className='card text-center my-3' style={{ width: '18rem' }}>
							...
							<div className='card-body'>
								<span className='badge bg-secondary p-2 mb-2'>SOFTWARE ARCHITECT</span>
								<h5 className='card-title p-1'>Gurpartap Lakhanpal</h5>
								<p className='card-text'>
									Gurpartap studied Mechanical Engineering at the University of Warwick. He's an avid listener
									of TedTalks Daily podcast.
								</p>
								<Button
					...
					<Col>
						<div className='card text-center my-3' style={{ width: '18rem' }}>
							...
							<div className='card-body'>
								<span className='badge bg-secondary p-2 mb-2'>PROJECT MANAGER</span>
								<h5 className='card-title p-1'>Kasia Dutch</h5>
								<p className='card-text'>
									Kasia holds a degree in Russian and Chinese, but now uses her language skills to build
									software. She's passionate about great UI.
								</p>
								<Button
					...
					<Col>
						<div className='card text-center my-3' style={{ width: '18rem' }}>
							...
							<div className='card-body'>
								<span className='badge bg-secondary p-2 mb-2'>QUALITY ASSURANCE</span>
								<h5 className='card-title p-1'>Sang Ta</h5>
								<p className='card-text'>
									Sang is a CompSci graduate from the University of Nottingham. As well as being our team's QA
									Tester, he also provides all the snacks.
								</p>
								<Button
