	...
	return (
		<Router>
			<Nav className='navbar p-2 mb-5 bg-light text-dark fixed-top d-flex align-content-center'>
				...
				<div>
					<h5 className='pt-2 text-dark text-center w-100 pl-2 mx-4'>THE WORLD FOR WOMEN</h5>
				</div>
				{setNavButtons()}
			</Nav>
				...
				<Switch>
					...
					<Route exact path='/register'>
						{registered ? (
							...
							<Register onEnterKey={onEnterKey} setRegister={setRegister} registered={registered} />
						)}
					</Route>
